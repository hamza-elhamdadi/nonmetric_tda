...
cmd_1 = 'echo "Metric compared to k = ' + str(1) +'" > bottleneck_values.txt'
...
cmd_3_2 = 'echo "" >> wasserstein_values.txt'
sp.call(['sh', '-c', cmd_1])
sp.call(['sh', '-c', cmd_2])
sp.call(['sh', '-c', cmd_3])
...
cmd_1 = 'echo "Metric compared to k = ' + str(1) +'" > wasserstein_values.txt'
...
for i in range(1,10):
    cmd_1 = 'echo "Metric compared to k = ' + str(i+1) +'" >> wasserstein_values.txt'
...
for i in range(10):
    for j in range(i+1,10):
        cmd_1 = 'echo "k = ' + str(i+1) + ' compared to k = ' + str(j+1) +'" >> wasserstein_values.txt'
